...
for det in dets:
    ...
    if make_plots:
        ...
        psd_plotter_helper(time, timemax, SNR, pcolor, det, eventname, plottype, 
                           tevent,strain_whitenbp, template_match, template_fft, 
                           datafreq, d_eff, data_psd, freqs, fs)
...
reqshift(strain_H1_whiten,fshift=fshift,sample_rate=fs)
