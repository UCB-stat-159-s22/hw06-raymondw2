...
def psd_plotter_helper(time, timemax, SNR, pcolor, det, eventname, plottype,tevent,strain_whitenbp, template_match, template_fft, datafreq, d_eff, data_psd, freqs, fs):
    # -- Plot the result
